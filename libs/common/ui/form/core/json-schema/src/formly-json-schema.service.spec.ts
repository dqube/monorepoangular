...
import { FormlyFieldConfig, FormlyTemplateOptions, FieldArrayType } from '@fse-form/core';
import { FormControl, FormGroup, FormArray } from '@angular/forms';
import { createComponent, FormlyInputModule } from '@fse-form/core/testing';
  ...
  describe('keyword support', () => {
    ...
    describe('Schema allOf support', () => {
      it('should merge allOf array into single object', () => {
        ...
        const expected = fieldGroup[0].fieldGroup.map(({ key, type, templateOptions: { required } }) => ({
          key,
          type,
          required,
        }));
