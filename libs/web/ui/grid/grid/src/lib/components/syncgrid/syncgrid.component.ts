...
import { GridColumns, GridOptions, GridSortSetting, GridSearchSetting, GridFilterSetting, QueryString, FilterEventModel, GridPageSetting } from '../../models/grid.config';
import {
  PageSettingsModel,
  GridComponent,
  FilterSettingsModel,
...
@Component({
  selector: 'fse-syncgrid',
  templateUrl: './syncgrid.component.html',
  styleUrls: ['./syncgrid.component.scss']
})
